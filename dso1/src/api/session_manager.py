...
class TrainingSessionManager:
    ...
    def start_session(self, delegue_id: int):
        if self.is_active:
        ...
        self.conv_thread = threading.Thread(
            ...
            args=(self.delegue, self.eval_thread, self.client, self.retriever),
            daemon=True
        )
    ...
    def _run_conversation(self, delegue, eval_thread, client, retriever):
