        ...
        <div className="col-span-5 flex flex-col bg-slate-800/30 rounded-3xl border border-slate-800 overflow-hidden shadow-2xl backdrop-blur-sm">
           ...
           <div className="p-6 border-t border-slate-800 bg-slate-900/50">
             <div className="flex gap-4">
                ...
                />
                <button onClick={() => handleSend()} className="w-14 h-14 bg-teal-500 rounded-2xl flex items-center justify-center text-white hover:bg-teal-400 transition-all shadow-xl shadow-teal-900/40">
                  <Send size={20} />
                </button>
             </div>
           </div>
