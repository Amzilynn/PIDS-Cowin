...
def load_model():
    ...
    audio_processor = Audio2Feature(model_path="openai/whisper-tiny")
...
def load_avatar(avatar_id):
    ...
    # Load all coordinate and latent data first
...
class MuseReal(BaseAvatar):
    ...
    def paste_back_frame(self,pred_frame,idx:int):
        ...
        # Avoid deepcopy for performance
        ...
        # Load and resize mask to match the target crop area dimension
        mask = self.mask_list_cycle[idx]
        mask_crop_box = self.mask_coords_list_cycle[idx]
        mx1, my1, mx2, my2 = mask_crop_box
        # Dynamically resize mask to match the rectangular patch dimension
        mask = cv2.resize(mask, (mx2-mx1, my2-my1))
