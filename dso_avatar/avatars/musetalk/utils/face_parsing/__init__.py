...
class FaceParsing():
    ...
    def model_init(self, 
        ...
        if resnet_path is None:
            resnet_path = os.path.join(base_dir, 'models/face-parse-bisent/resnet18-5c106cde.pth')
        if model_pth is None:
            model_pth = os.path.join(base_dir, 'models/face-parse-bisent/79999_iter.pth')
